...
let s:palette = sonokai#get_palette('andromeda', s:configuration.colors_override)
let s:path = expand('<sfile>:p') " the path of this script
let s:last_modified = 'Mon Apr 24 19:33:44 UTC 2023'
let g:sonokai_loaded_file_types = []

if !(exists('g:colors_name') && g:colors_name ==# 'sonokai-andromeda' && s:configuration.better_performance)
  highlight clear
  if exists('syntax_on')
    syntax reset
  endif
...
let g:colors_name = 'sonokai-andromeda'
